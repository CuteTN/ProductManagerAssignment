...
namespace ProductManager.Migrations
{
    ...
    [Migration("20211006194143_EditRefreshTokenColumns")]
    partial class EditRefreshTokenColumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductManager.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProductManager.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProductManager.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductManager.Models.RefreshToken", b =>
                {
                    b.HasOne("ProductManager.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
